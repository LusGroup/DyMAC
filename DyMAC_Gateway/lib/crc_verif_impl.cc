...
namespace gr
{
    namespace lora_sdr
    {
        ...
        crc_verif::sptr
        crc_verif::make(double frequency,uint8_t sf,uint8_t freqIndex)
        {
            return gnuradio::get_initial_sptr(new crc_verif_impl(frequency,sf,freqIndex));
        }

        /*
     * The private constructor
     */
        crc_verif_impl::crc_verif_impl(double frequency,uint8_t sf,uint8_t freqIndex)
            : gr::block("crc_verif",
     ...
     */
        ...
        void
        crc_verif_impl::broardcastChannelState(){
            ...
            message_port_pub(m_LogicalStatePort,dict);
        }
